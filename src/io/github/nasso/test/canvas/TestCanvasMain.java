...
public class TestCanvasMain implements GameRunner {
	...
	private TestCanvasSketch sketch;
	
	public TestCanvasMain() {
	...
	public void init() {
		...
		this.sketch = new TestCanvasSketch();
		this.sketch.setup();
	}
	
	public void update(float delta) {
		this.sketch.update(this.game.window(), delta);
