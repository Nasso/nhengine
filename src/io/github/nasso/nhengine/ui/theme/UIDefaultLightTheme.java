...
public class UIDefaultLightTheme extends UIDefaultTheme {
	public static final Color PANE_BG = Color.get(0.94f);
	public static final Color SEPARATOR_COLOR = Color.get(0.75f);
	public static final Color TEXT_COLOR = Color.get(0.2f);
	public static final Color BUTTON_COLOR = Color.get(0.85f);
	public static final Color BUTTON_BORDER_COLOR = Color.get(0.75f);
	public static final Color BUTTON_HOVER_COLOR = Color.get(0.9f);
	public static final Color BUTTON_PRESSED_COLOR = Color.get(0.95f);
	...
	public static final Color TOGGLE_BUTTON_UNSEL_COLOR = Color.get(0.75f);
	public static final Color POPUP_BG = Color.get(0.91f);
	public static final Color MENUBAR_BG = Color.get(0.86f);
	public static final Color PROGRESSBAR_BG = Color.get(0.7f);
	public static final Color PROGRESSBAR_FG = Color.get(0.9f);
	public static final Color SLIDER_BG = Color.get(0.7f);
	...
	public static final Color TEXTFIELD_BG = Color.get(0.85f);
	public static final Color TEXTFIELD_BORDER_COLOR = Color.get(0.75f);
	public static final Color TABBEDPANE_BG = Color.get(0.75f);
	public static final Color TAB_BG = Color.get(0.85f);
	public static final Color ACTIVETAB_BG = Color.get(0.94f);
	public static final Color TAB_CLOSE_BG = Color.get(0.75f);
	public static final Color TAB_CLOSE_FG = Color.get(1f);
	public static final Color TAB_CLOSE_HOVER_BG = Color.get(1f, 0.5f, 0.5f);
	public static final Color SCROLL_BAR_ARROW_BTN_BG = Color.get(0.8f);
	public static final Color SCROLL_BAR_BG = Color.get(0.9f);
	public static final Color SCROLL_BAR_THUMB = Color.get(0.8f);
	public static final Color SCROLL_BAR_THUMB_BORDER = Color.get(0.9f);
	public static final Color DIALOG_TITLEBAR_BG = Color.get(0.86f);
	public static final Color DIALOG_CLOSE_BUTTON_COLOR = Color.get(0.75f);
	public static final Color DIALOG_CLOSE_BUTTON_HOVER_COLOR = Color.get(1f, 0.5f, 0.5f);
	public static final Color DIALOG_CLOSE_BUTTON_PRESSED_COLOR = Color.get(0.8f, 0.4f, 0.4f);
	public static final Color DIALOG_MODAL_FOCUS_COLOR = Color.ROYAL_BLUE;
	
	public UIDefaultLightTheme(boolean smoothFont) {
		super(smoothFont);
	}
	
	public UIDefaultLightTheme() {
		super();
	}
